<script lang="ts">
  ...
  import { numberSecToTime } from "$lib/utils";
    ...
    class Service {
        ...
        constructor(id: number, name: string, description: string, owner: string, status: string, location: string, rto: number, rpo: number, vendorName: string, tags: string[], createdAt: Date, updatedAt: Date) {
            this.id = id;
            this.name = name;
    ...
    let mockData: Service[] = [
        new Service(1, 'Service 1', 'Service 1 description', 'Owner 1', 'Active', 'Location 1', 5678889999, 665, 'Vendor 1', ['tag1', 'tag2'], new Date(), new Date()),
        new Service(2, 'Service 2', 'Service 2 description', 'Owner 2', 'Active', 'Location 2', 55556, 5, 'Vendor 2', ['tag1', 'tag2'], new Date(), new Date()),
        new Service(3, 'Service 3', 'Service 3 description', 'Owner 3', 'Active', 'Location 3', 345, 5465, 'Vendor 3', ['tag1', 'tag2'], new Date(), new Date()),
        new Service(4, 'Service 4', 'Service 4 description', 'Owner 4', 'Active', 'Location 4', 236785, 234567875, 'Vendor 4', ['tag1', 'tag2'], new Date(), new Date()),
        new Service(5, 'Service 5', 'Service 5 description', 'Owner 5', 'Active', 'Location 5', 5678905, 4565, 'Vendor 5', ['tag1', 'tag2'], new Date(), new Date()),
    ];
    ...
    let tableShape: TableShape = {
        columns: [
            ...
            { name: 'Vendor Name', color: 'blue', type: Types.select, field: (data: Service) => data.vendorName, choices: [{ value: 'Vendor 1', label: 'Vendor 1' }, { value: 'Vendor 2', label: 'Vendor 2' }, { value: 'Vendor 3', label: 'Vendor 3' }, { value: 'Vendor 4', label: 'Vendor 4' }, { value: 'Vendor 5', label: 'Vendor 5' }] },
    ...
    let createData: Service = new Service(0, '', '', '', '', '', 0, 0, '', [], new Date(), new Date());
</script>
<main>
    <div class="vendors">
