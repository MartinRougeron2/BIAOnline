<script lang="ts">
  ...
  let mockData: Activity[] = [
    ...
    new Activity({
      ...
      frequency: "Daily",
      services: [
        { id: 1, name: "Service 1", RTO: 567888, RPO: 665 , vendor: { id: 1, name: "Vendor 1" } },
        { id: 2, name: "Service 2", RTO: 567888, RPO: 665 , vendor: { id: 2, name: "Vendor 2" } },
        { id: 3, name: "Service 3", RTO: 567888, RPO: 665 , vendor: { id: 3, name: "Vendor 3" } },
        { id: 4, name: "Service 4", RTO: 567888, RPO: 665 , vendor: { id: 4, name: "Vendor 4" } },
        { id: 5, name: "Service 5", RTO: 567888, RPO: 665 , vendor: { id: 5, name: "Vendor 5" } },
      ],
      teams: [
        { id: 1, name: "Team 1" },
        { id: 2, name: "Team 2" },
